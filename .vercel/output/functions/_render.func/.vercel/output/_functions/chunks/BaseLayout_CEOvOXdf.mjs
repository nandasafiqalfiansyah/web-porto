import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, d as renderComponent, g as createTransitionScope, h as renderHead, e as renderSlot } from './astro/server_DUJsmr6u.mjs';
import 'kleur/colors';
...
}, "C:/Users/USER/Documents/GitHub/Final-Porto/astro-portfolio/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "C:/Users/USER/Documents/GitHub/Final-Porto/astro-portfolio/src/components/HeadSEO.astro", void 0);
...
Built by${" "} <a href="https://github.com/nandasafiqalfiansyah" target="_blank" rel="noreferrer" class="font-medium underline underline-offset-4">
Nanda Safiq Alfiansyah
</a>
. with <span class="text-red-500">❤️</span> From Indonesia
</p> </div> </footer>`;
}, "C:/Users/USER/Documents/GitHub/Final-Porto/astro-portfolio/src/components/Footer.astro", void 0);
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(["<script>\n  document.addEventListener('astro:after-swap', function () {\n    if (localStorage.getItem('theme') === 'dark')\n      document.documentElement.classList.toggle('dark', true)\n  })\n\n  const getThemePreference = () => {\n    return localStorage.getItem('theme')\n  }\n\n  const isDark = getThemePreference() === 'dark'\n  document.documentElement.classList[isDark ? 'add' : 'remove']('dark')\n<\/script> ", '<header class="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60"> <div class="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0"> <div class="flex gap-6 md:gap-10"> <a href="/" class="flex items-center space-x-2"> <span class="inline-block font-bold">.ndav</span> </a> </div> <div class="flex flex-1 items-center justify-end space-x-4"> <nav class="flex items-center space-x-1"> <a href="https://github.com/nandasafiqalfiansyah" target="_blank" rel="noreferrer"', ">\nGitHub\n</a> ", " </nav> </div> </div> </header>"])), maybeRenderHead(), addAttribute(buttonVariants({ variant: "ghost" }), "class"), renderComponent($$result, "ModeToggle", ModeToggle, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/USER/Documents/GitHub/Final-Porto/astro-portfolio/src/components/ui/ThemeToggle", "client:component-export": "ModeToggle", "data-astro-transition-persist": createTransitionScope($$result, "hkvsjyzz") }));
}, "C:/Users/USER/Documents/GitHub/Final-Porto/astro-portfolio/src/components/Header.astro", "self");
...
}, "C:/Users/USER/Documents/GitHub/Final-Porto/astro-portfolio/src/layouts/BaseLayout.astro", void 0);
